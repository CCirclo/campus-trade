export type User = { id:number; email:string; nickname:string; avatarUrl:string; schoolId:string; wechatId:string; verified:boolean; campusVerified:boolean; adminVerified:boolean; selfOperated:boolean; emailMessageNotifications:boolean; role:'user'|'admin' };
...
export type AdminUser = { id:number; email:string; nickname:string; avatarUrl:string; role:'user'|'admin'; verified:boolean; emailVerified:boolean; adminVerified:boolean; selfOperated:boolean; campusVerified:boolean; emailMessageNotifications:boolean; createdAt:string; lastSeenAt:string|null; itemCount:number };
